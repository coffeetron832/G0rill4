...
const translations = {
  ...
  vi: {
    tagline: "Hãy để chú khỉ đột nghiền nát tệp của bạn!",
    formats: "Định dạng hỗ trợ: <strong>JPG, PNG, WEBP, PDF, MP3, WAV, MP4, WEBM, SVG, JSON, CSV, TXT</strong> (Tối đa 100 MB)",
    tabsGuide: "💡 Bạn có thể mở nhiều thẻ bằng nút <strong>+</strong> để xử lý các tệp khác nhau cùng lúc.",
    rights: "Đã đăng ký bản quyền.",
    dropText: "<strong>Kéo & thả tệp vào đây</strong><br>hoặc nhấp để chọn",
    dropTextZip: "<strong>Kéo & thả các tệp của bạn vào đây</strong><br>để tạo gói .ZIP",
    noFile: "Chưa chọn tệp nào",
    compressBtn: "Nén",
    createZipBtn: "Tạo gói .ZIP",
    zipPackageLabel: "Tên tệp ZIP:",
    zipContentLabel: "Nội dung gói:",
    filesSelected: "tệp đã chọn",
    statusLabel: "Trạng thái: ",
    statusIdle: "● Đang chờ",
    statusReady: "● Sẵn sàng xử lý",
    statusZipReady: "● Sẵn sàng đóng gói",
    statusPreview: "● Đang tải xem trước...",
    statusProcessing: "⏳ Đang nghiền tệp...",
    statusZipBuilding: "⏳ Đang tạo gói .ZIP...",
    statusEncodingAudio: "⏳ Đang mã hóa âm thanh MP3...",
    statusEncodingVideo: "⏳ Đang mã hóa lại video (FFmpeg)...",
    statusDone: "✔ Hoàn thành",
    mOrig: "Kích thước gốc:",
    mComp: "Kích thước cuối:",
    mSaved: "Dung lượng tiết kiệm:",
    mRatio: "Tỷ lệ giảm:",
    mMethod: "Phương pháp sử dụng:",
    downloadPrefix: "Tải về",
    defaultTabTitle: "Tệp",
    newTabTitle: "Thẻ mới",
    limitError: "✖ Tệp vượt quá giới hạn 100MB",
    unsupportedError: "Loại tệp không được hỗ trợ nén trực tiếp.",
    // Alternancia de Modos
    askZipMode: "Bạn muốn đóng gói nhiều tệp vào một tệp nén?",
    btnToZip: "Tạo tệp .ZIP",
    askCompressMode: "Bạn muốn giảm kích thước của một tệp riêng lẻ?",
    btnToCompress: "Giảm kích thước tệp",
    // Methods
    imgMethod: "Tối ưu hóa hình ảnh",
    imgDesc: "Điều chỉnh kích thước, xóa dữ liệu ẩn EXIF và cân bằng chất lượng để giảm dung lượng mà không làm mất chi tiết.",
    pdfMethod: "Tối ưu hóa cấu trúc",
    pdfDesc: "Sắp xếp lại dữ liệu nội bộ của PDF và xóa dữ liệu trùng lặp trong khi vẫn giữ nguyên các trang.",
    audioMethod: "Nén âm thanh MP3",
    audioDesc: "Điều chỉnh tốc độ bit thành 128 kbps, giảm đáng kể dung lượng mà không làm ảnh hưởng đến trải nghiệm nghe.",
    videoMethod: "Nén video HD",
    videoDesc: "Tối ưu hóa độ phân giải tối đa xuống 720p và điều chỉnh khung hình để giảm dung lượng mà vẫn mượt mà.",
    textMethod: "Xóa khoảng trắng",
    textDesc: "Xóa các khoảng trắng, dòng trống và tab thừa trong tệp mà không làm thay đổi nội dung.",
    zipMethod: "Đóng gói ZIP",
    zipDesc: "Gom nhiều tệp vào một tệp nén .ZIP mà không làm giảm chất lượng.",
    // Tooltip
    bananaTooltip: "🍌 Kéo tôi đến chỗ chú khỉ đột!"
  }
};
